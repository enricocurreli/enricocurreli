...
**Languages:**
- HTML, CSS, JavaScript, PHP, TypeScript, Python
...
### BlackWave
- **Description:** Full-stack web app promoting products and services during Black Friday, with user authentication and a modern UI.
- **Tech Stack:** Laravel, React, TypeScript, Tailwind CSS, daisyUI, MagicUI, Inertia.js, Laravel Breeze
- **Repo:** [Black-Yellow-Friday](https://github.com/enricocurreli/Black-Yellow-Friday)
...
### FLY FOOD
- **Description:** A delivery-focused web application providing a seamless and intuitive product selection and checkout experience.
